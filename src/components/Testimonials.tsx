...
export default function Testimonials() {
  return (
    <section className="relative overflow-hidden bg-blue-600/5 py-20">
      {/* Enhanced Background Patterns */}
      <div className="absolute inset-0">
        {/* Main gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/80 via-blue-50/40 to-transparent" />
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-200/40 rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
      ...
      {/* Floating shapes */}
      <div className="absolute top-20 left-20 w-24 h-24 bg-blue-200/30 rounded-lg rotate-12 blur-sm" />
      <div className="absolute bottom-20 right-20 w-32 h-32 bg-emerald-200/30 rounded-full blur-sm" />
      <div className="absolute top-1/3 right-1/4 w-20 h-20 bg-blue-200/30 rounded-lg -rotate-12 blur-sm" />
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center relative">
                <div className="relative size-24 rounded-full overflow-hidden mr-4 border border-blue-500">
                  <img
